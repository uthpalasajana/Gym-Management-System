...
public class newMember extends javax.swing.JFrame {
    ...
    // ✅ Manually set a fixed date: 2001-10-06
    java.sql.Date dateRegister = null;
    try {
        String manualDate = "2001-10-06";
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        java.util.Date date = sdf.parse(manualDate);
        dateRegister = new java.sql.Date(date.getTime());
    } catch (ParseException pe) {
        JOptionPane.showMessageDialog(null, "Invalid date format: " + pe.getMessage());
        pe.printStackTrace();
    ...
    try {
        ...
        statement.setString(12, null); // Assuming last column is nullable
        ...
        JOptionPane.showMessageDialog(null, "Error saving information", "Error", JOptionPane.PLAIN_MESSAGE);
        e.printStackTrace();
    }
    ...
    try {
        ...
        while (result.next()) {
            ...
            PreparedStatement paymentSt = connection.prepareStatement(
                "INSERT INTO payment (ID, memberName, memberType, amountPay) VALUES (?,?,?,?)"
            );
